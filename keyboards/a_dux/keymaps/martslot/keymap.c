...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_GAMING] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT,
                                            LA_GAMX, KC_SPC,  LA_QWER, LA_GAMX
    ),

    [LAYER_GAMING_EXTRA] = LAYOUT(
        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      SW_WIN,  KC_MPLY, KC_MUTE, KC_VOLD, KC_VOLU,
